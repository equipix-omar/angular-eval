...
export class RolesComponent {
  ...
  constructor(
   ...
   getstatus(){
    this._PermissionService.getAllrole().subscribe((res:any) =>
    {
    ...
    destroy(id:any)
    {
      ...
      this._PermissionService.deleteRole(id,Helper.toFormData(this.item)).subscribe((res:any) => {
        ...
        setTimeout(() =>
            ...
            this.toastr.error("Role Deleted Successfully.")
