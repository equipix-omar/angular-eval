 ...
 const topOfferData = [
  {
      ...
      btn_color: "bg-info",
      image: [
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/06.jpg"},
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/06.jpg"}
      ],
      sale: 'For rent',
  ...
  },
  {
    ...
    btn_color: "bg-info",
    image: [
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/07.jpg"},
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/07.jpg"}
      ],
    sale: 'For sale',
  ...
  },
  {
    ...
    btn_color: "bg-info",
    image: [
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/08.jpg"},
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/08.jpg"}
      ],
    sale: 'For rent',
  ...
  },
  {
    ...
    btn_color: "",
    image: [
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/09.jpg"},
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/09.jpg"}
      ],
    sale: 'For rent',
  ...
  },
  {
    ...
    btn_color: "bg-danger",
    image: [
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/10.jpg"},
        {img : "https://equipix-assets.s3.us-west-2.amazonaws.com/img/real-estate/catalog/10.jpg"}
      ],
    sale: 'For rant',
